        ...
        <div className="flex w-full items-center justify-between">
          <Link href="/" className="flex items-center">
            <h2 className="flex items-center ml-2 sm:ml-4">
              ...
              <span className="pl-2 font-semibold sm:block sm:text-4xl hidden">
                <span>그냥 저냥 기록소</span>
              </span>
              <span className="pl-2 font-semibold sm:hidden">
                <span>기록소</span>
              </span>
            </h2>
          </Link>

          <form className=" relative mx-0 sm:mx-4 " action={handleSubmit}>
